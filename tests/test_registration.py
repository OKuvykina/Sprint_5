...
#успешная регистрация
    def test_registration_success(self, driver_open):
    ...
    #заполняем форму регистрации
        ...
        driver_open.find_element(*Locators.EMAIL_INPUT_XPATH).send_keys(helpers.generation_email())
    ...
    def test_registration_fail_incorrect_password(self, driver_open, incorrect_password):
